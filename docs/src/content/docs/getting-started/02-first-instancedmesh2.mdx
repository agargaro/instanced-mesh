...
description: Initialize an InstancedMesh2, add instances and set their positions, followed by a complete live example.
---

This guide walks through creating an `InstancedMesh2`, adding instances and positioning them.
