...
`InstancedMesh2` uses a `DataTexture` to store instances matrices and data, while using an `InstancedBufferAttribute` to manage the indexes of the instances to be rendered.
