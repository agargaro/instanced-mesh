...
description: Animate one or many instances using updateMatrix, a for loop, or the recommended updateInstances method.
---

Instances can be animated individually, in a loop, or all at once with `updateInstances`.
...
:::caution
[If an array of instances](https://agargaro.github.io/instanced-mesh/basics/01-instancedentity/) has **not** been created,
