---
title: Raycasting
description: Raycast instances linearly or with a BVH, and restrict checks to instances rendered in the previous frame with raycastOnlyFrustum.
---

This page covers the two raycasting approaches and the `raycastOnlyFrustum` option.
