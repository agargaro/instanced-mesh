...
export function getRawSphereFromMatrix_centeredGeometry(id: number, array: FloatArray, target: SphereTarget): SphereTarget {
    const offset = id * 16;
...
export function getSphereFromArray_centeredGeometry(id: number, array: FloatArray, sphere: Sphere, radius: number): void {
    const offset = id * 16;
    ...
    center.x = array[offset + 12];
    center.y = array[offset + 13];
    center.z = array[offset + 14];
}
